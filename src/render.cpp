...
SDL_Renderer *RenderWindow::getRenderer() { return m_renderer; }
SDL_Window *RenderWindow::getWindow() { return m_window; }

void RenderWindow::blank(const SDL_Color& colour)
{
...
void RenderWindow::renderPresent() { SDL_RenderPresent(m_renderer); }
